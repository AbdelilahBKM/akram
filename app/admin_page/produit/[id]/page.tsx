    ...
    if (
      ...
      try {
        ...
        if (response.ok) {
          ...
          setCategorie(result.categorie.id);
          setImageName(null);
        } else {
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Cette action ne peut pas être annulée. Cela remplacera les
                    anciennes informations sur l&apos;article par les nouvelles.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
